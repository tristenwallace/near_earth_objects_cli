...
class CloseApproach:
    ...
    def __str__(self):
        """Return `str(self)`."""
        return f"A CloseApproach by {self.neo.fullname} happened at "\
                f"{self.time_str}, approaching earth at a distance of "\
